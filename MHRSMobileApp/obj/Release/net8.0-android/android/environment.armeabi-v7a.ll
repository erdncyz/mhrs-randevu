...
@dso_cache = dso_local local_unnamed_addr global [540 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 50433425, ; hash 0x3018d91, from name: MHRSMobileApp
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1243999997, ; hash 0x4a25eefd, from name: libaot-MHRSMobileApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MHRSMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 139
	...
	%struct.DSOCacheEntry {
		i64 1865713308, ; hash 0x6f34869c, from name: aot-MHRSMobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MHRSMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 216
	...
	%struct.DSOCacheEntry {
		i64 3391730181, ; hash 0xca29b205, from name: libaot-MHRSMobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MHRSMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 435
	...
	%struct.DSOCacheEntry {
		i64 3670184446, ; hash 0xdac291fe, from name: MHRSMobileApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MHRSMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 467
	...
	%struct.DSOCacheEntry {
		i64 4132810230, ; hash 0xf655adf6, from name: aot-MHRSMobileApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MHRSMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 523
